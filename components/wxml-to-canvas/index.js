        ...
        if (use2dCanvas) {
          ...
          query.select(`#${canvasId}`)
            ...
            .exec(res => {
              ...
              // console.log("attached", canvas.width + ", " + canvas.height + ", " + dpr)
              //canvas2d模式下，canvas宽高不能大于4096, 所以当canvas的宽或高大于4096时，使用旧版canvas api
...
class Draw {
  ...
  drawText(text, box, style) {
    ...
    //兼容android端
    ctx.setFontSize && ctx.setFontSize(fontSize)
